...
<head>
  ...
  <title>Project verification Management System</title>
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="#" class="brand-link">
      ...
      <span class="brand-text font-weight-bold text-white">PVMS</span>
    </a>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="departAdd.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add department</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="manageDepart.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="optionAdd.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add Option</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="manageOpt.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Manage Options</p>
                </a>
              </li>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="projectAdd.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add Project</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="manageProject.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Manage Projects</p>
                </a>
              </li>
